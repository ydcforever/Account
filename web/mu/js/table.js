...
Table.simple = {
     ...
     * @param titles
     */
    horizontal_new: function ($table, objects, titles) {
        var table = '<tr>';
        if (titles == undefined) {
    ...
    horizontal: function ($table, objects, titles,func,key) {
        var table = '<tr>';
        if (titles == undefined) {
            $.each(objects[0], function (field, val) {
                table += '<td>' + field + '</td>';
        ...
        $(objects).each(function () {
            ...
            if (titles == undefined) {
                ...
                table += '<td><a href=\"'+func+ '\">查看</a></td>';
            } else {
                $(titles).each(function () {
                    table += '<td>' + (object[this.field] == undefined ? "" : object[this.field]) + '</td>';
                });
                table += '<td><a href=\"'+func+ '?ticketNo='+object[this.key]+'\">查看</a></td>';
            }
            table += '</tr>';
        });
